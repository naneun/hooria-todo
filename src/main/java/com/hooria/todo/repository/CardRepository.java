...
public class CardRepository {
    ...
    public List<Card> findAll() {
        return jdbc.query(
            "select id, status, title, content, user_id, appliance_info, created_at, modified_at, deleted_yn, index from todo_card where deleted_yn = false",
    ...
    public Optional<Card> findById(long id) {
        ...
        List<Card> result = jdbc.query(
            "select id, status, title, content, user_id, appliance_info, created_at, modified_at, deleted_yn, index from todo_card where id = :id",
    ...
    public Card update(Card card) {
        ...
        jdbc.update("update todo_card set status = :status, title = :title, content = :content, user_id = :user_id, "
